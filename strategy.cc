                ...
                */
                ...
                if (worldModel->getUNum() == 2) { // striker
                   ...
                   // this will return a location, if you're close to the ball kick it towards the location, else walk towards the location
                	...
                	if (imClosestToBall) {
                		char command[200];
	                    snprintf(command, sizeof(command), "python /home/ryan/591/hw3/planner/wrapper.py %d %d %d 'touchdown' %c%c %c%c %c%c 2>&1 &", worldModel->getUNum(), playerClosestToBall, closeVal, strikerPos[0], strikerPos[1], leftPos[0], leftPos[1], rightPos[0], rightPos[1]);
	                    system(command);
	                    cout << command << endl;
                	} else {
                		char command[200];
	                    snprintf(command, sizeof(command), "python /home/ryan/591/hw3/planner/wrapper.py %d %d %d 'at striker EI' %c%c %c%c %c%c 2>&1 &", worldModel->getUNum(), playerClosestToBall, closeVal, strikerPos[0], strikerPos[1], leftPos[0], leftPos[1], rightPos[0], rightPos[1]);
	                    system(command);
	                    cout << command << endl;
                	}
                	...
                	if (imClosestToBall) {
                		...
                		char command[200];
	                    snprintf(command, sizeof(command), "python /home/ryan/591/hw3/planner/wrapper.py %d %d %d 'at left CI' %c%c %c%c %c%c 2>&1 &", worldModel->getUNum(), playerClosestToBall, closeVal, strikerPos[0], strikerPos[1], leftPos[0], leftPos[1], rightPos[0], rightPos[1]);
	                    system(command);
	                    cout << command << endl;
                	}
                	...
                	if (imClosestToBall) {
                		...
                		char command[200];
	                    snprintf(command, sizeof(command), "python /home/ryan/591/hw3/planner/wrapper.py %d %d %d 'at right HI' %c%c %c%c %c%c 2>&1 &", worldModel->getUNum(), playerClosestToBall, closeVal, strikerPos[0], strikerPos[1], leftPos[0], leftPos[1], rightPos[0], rightPos[1]);
	                    system(command);
	                    cout << command << endl;
                	}
